...
import { generateMockTransaction, formatCardNumber, validateCardNumber, validateName, validatePhoneNumber, validateAmount, detectCardType } from '../utils/mockData';
...
function TransactionForm({ onTransaction }) {
  ...
  const handleSubmit = async () => {
    ...
    setTimeout(() => {
      const transaction = generateMockTransaction(cardNumber, name, phoneNumber, amount);
      onTransaction(transaction);
      setLastTransaction(transaction);
      setMessage(`Transaction ${transaction.status}! ID: ${transaction.id}`);
